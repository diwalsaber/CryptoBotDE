...
def app():
    ...
    st.write(
        "Cette application a été conçue pour vous aider à comprendre les "
        ...
        "et ensuite générer une prédiction en cliquant simplement sur un bouton."
    )

    st.write(
        "Avant de commencer, il est important de noter que, bien que nos "
        ...
        "mais restez prudent et conscient des risques."
    )
